$(function () {
    ...
    $(".qa").on("click", function () {
        $(".qa").siblings(".inbox").stop().slideUp(500);
        $(this).siblings(".inbox").stop().slideToggle(500);
    });

    //QA 페이지버튼 hover시 보더 진하게
    $(".box_navi > li").on("mouseenter", function () {
        $(this).addClass("borderCol");
    });
    $(".box_navi > li").on("mouseleave", function () {
        $(this).removeClass("borderCol");
    });
